...
const { generateProjectId, generateKeyId } = require('../utils/id-generator');
...
exports.createProject = async (req, res) => {
  try {
    ...
    if (!merchantId) {
      return res.status(400).json({ error: 'User must have a merchant account. Please create a merchant account first.' });
    }
